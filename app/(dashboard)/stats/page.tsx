        ...
        <div className="@container/main flex flex-1 flex-col gap-4 p-4 pb-0 md:gap-6 md:p-6 md:pb-0">
          ...
          <div className="space-y-6">
            ...
            {activeTab === "Events" && loading ? (
              ...
              <div
                className={`grid gap-4 md:grid-cols-2 lg:grid-cols-4 transition-opacity duration-200 ${isRefetching ? "opacity-60" : "opacity-100"}`}
              >
                {/* Total Events */}
            ...
            {activeTab === "Jobs" && loading ? (
              ...
              >
                ...
                <Card variant="revealed-pointer">
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">
                      {stats.jobStats.total.toLocaleString()}
                    </div>
                    <p className="text-xs text-muted-foreground">
                      {stats.jobStats.queued} queued,{" "}
                      {stats.jobStats.processing} processing
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card variant="revealed-pointer">
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">
                      {stats.jobStats.successRate.toFixed(1)}%
                    </div>
                    <p className="text-xs text-muted-foreground">
                ...
                <Card variant="revealed-pointer">
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">
                      {stats.detectionStats.totalFrames.toLocaleString()} frames
                      analyzed
                    </p>
                  </CardContent>
                </Card>
            ...
            {activeTab === "Events" && loading ? (
              ...
              <div
                className={`grid gap-6 md:grid-cols-2 xl:grid-cols-3 transition-opacity duration-200 ${isRefetching ? "opacity-60" : "opacity-100"}`}
              >
                {/* Event Severity */}
