...
export function RecordingCard({ asset, onUpdate, onDelete }: RecordingCardProps) {
    ...
    <>
      <Card variant="revealed-pointer" className="group relative overflow-hidden transition-all hover:shadow-lg py-0">
        <CardContent className="p-0 pb-4">
            ...
            {hasError || asset.status === "errored" ? (
              <div className="absolute inset-0 flex flex-col items-center justify-center bg-muted text-muted-foreground p-4">
                <div className="text-center">
                  ...
                  <p className="text-xs mt-1">{asset.status === "errored" ? "Processing failed" : "This recording cannot be played"}</p>
                </div>
              </div>
          ...
          {/* Recording Info */}
          <div className="px-4 space-y-3 cursor-pointer" onClick={handleCardClick}>
            {/* {asset.meta?.title && (
              ...
              <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      Are you sure you want to delete "{asset.meta?.title || asset.id}"? This will permanently delete the asset and cannot be undone.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
            ...
            <div className="flex items-center gap-2 pt-2 border-t flex-wrap">
              ...
              {asset.is_live && (
                <Badge variant="outline" className="bg-purple-500/10 text-purple-700 dark:text-purple-300 border-purple-500/20 text-xs h-5">
                  Currently Live
                </Badge>
              )}
            </div>
